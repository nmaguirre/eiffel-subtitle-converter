...
feature {NONE} -- Implementation / Constants
	...
	Default_message: STRING =
		...
		%License%N%
		%© 2015 DOSE-2015 UNRC%N%
		%THE SOFTWARE IS PROVIDED AS IS, WITHOUT WARRANTY %N%
		%OF ANY KIND, EXPRESS OR IMPLIED,%N%
		%INCLUDING BUT NOT LIMITED TO THE WARRANTIES OF %N%
		%MERCHANTABILITY, FITNESS FOR A PARTICULAR %N%
		%PURPOSE AND NONINFRINGEMENT. IN NO EVENT SHALL THE %N%
		%AUTHORS OR COPYRIGHT HOLDERS BE LIABLE FOR %N%
		%ANY CLAIM, DAMAGES OR OTHER LIABILITY, WHETHER %N%
		%IN AN ACTION, PUTO EL QUE LEE, OF CONTRACT, TORT %N%
		%OR OTHERWISE,ARISING FROM, OUT OF OR IN CONNECTION WITH THE %N%
